...
void input_nist(unsigned char* INPUT, unsigned char* OUTPUT, unsigned long long int* LEN, int sel, int b, int DBG) {
	...
	sprintf(file_byte_short, "%s", "NIST_TestVector/shabytetestvectors/");
	sprintf(file_byte_long, "%s", "NIST_TestVector/shabytetestvectors/");
	sprintf(file_bit_short, "%s", "NIST_TestVector/shabittestvectors/");
	sprintf(file_bit_long, "%s", "NIST_TestVector/shabittestvectors/");

	strcat(file_byte_short, NAME);
	strcat(file_byte_long, NAME);
	strcat(file_bit_short, NAME);
	strcat(file_bit_long, NAME);
