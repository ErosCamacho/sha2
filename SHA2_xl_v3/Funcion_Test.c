...
void input_nist(unsigned char* INPUT, unsigned char* OUTPUT, unsigned long long int* LEN, int sel, int b, int DBG) {
	...
	sprintf(file_byte_short, "%s", "shabytetestvectors/");
	sprintf(file_byte_long, "%s", "shabytetestvectors/");
	sprintf(file_bit_short, "%s", "shabittestvectors/");
	sprintf(file_bit_long, "%s", "shabittestvectors/");
